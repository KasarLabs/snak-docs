...
<Callout type="info">
  Each plugin has its own directory under `./plugins/` with a
...
You can explore the implemented plugins and their available actions directly in the source code under [`./plugins`](https://github.com/KasarLabs/starknet-agent-kit/tree/main/plugins) or through our high-level plugin interface.
