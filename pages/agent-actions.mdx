...
<Cards>
  ...
  <Card icon={<Puzzle />} title="Plugin Architecture" href="#plugin-architecture">
...
<Callout type="info">
Each protocol has its own directory under `lib/agent/methods/` with a standardized structure for organization.
</Callout>
...
<Cards>
  ...
  <Card icon={<Puzzle />} title="Integrate LangChain Actions" href="/integrate-langchain-tools">
