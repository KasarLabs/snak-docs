...
You can explore the implemented plugins and their available actions directly in the source code under [`src/lib/agent/plugins`](https://github.com/KasarLabs/snak/tree/main/src/lib/agent/plugins) or through our high-level plugin interface.
